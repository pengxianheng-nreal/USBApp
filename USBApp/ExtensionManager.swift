...
class ExtensionManager : NSObject, OSSystemExtensionRequestDelegate {
    ...
    func activate() {
        let activationRequest = OSSystemExtensionRequest.activationRequest(forExtensionWithIdentifier: "com.xreal.MyUserUSBInterfaceDriver.driver", queue: .main)
    ...
    func deactivate() {
        ...
        let activationRequest = OSSystemExtensionRequest.deactivationRequest(forExtensionWithIdentifier: "com.xreal.MyUserUSBInterfaceDriver.driver", queue: .main)
        activationRequest.delegate = self
        OSSystemExtensionManager.shared.submitRequest(activationRequest)
    }
